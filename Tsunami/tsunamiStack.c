...
void femTsunamiPreJac(femShallowProblem* theProblem){
	...
	double jacElem[nElem*(theRule->n+1)];
	double dphidxElem[nElem*theRule->n*n];
	double dphidyElem[nElem*theRule->n*n];
	double xElem[nElem*theRule->n];
	double yElem[nElem*theRule->n];
	double hElem[nElem*theRule->n];
	double latElem[nElem*theRule->n];
